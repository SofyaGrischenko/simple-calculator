...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `*{padding:0;margin:0;border:0 solid rgba(0,0,0,0)}.main{min-height:100vh;background-color:#faf1e6;color:#99bc85;display:flex;flex-wrap:wrap;flex-direction:column;align-items:center}.input{margin:4rem 0;background-color:#fdfaf6;width:50vw;height:10rem;font-size:5rem;color:inherit;text-align:end;padding-right:2rem;border-radius:50px;box-shadow:.5em .5em #99bc85,-0.5em -0.5em #c5705d}.input:focus{outline:none}.button{outline:none;width:10rem;height:10rem;font-size:4rem;background-color:#e4efe7;color:inherit;transition:.2s ease-in;cursor:pointer}.button:hover{background-color:#99bc85;color:#e4efe7}.button:active{opacity:.5}.keyboard{display:flex;flex-wrap:wrap;gap:1rem}.numpad{display:grid;grid-template-columns:repeat(3, 33%);justify-content:center}.operators{display:grid;grid-template-columns:repeat(2, 50%)}`, ""]);
// Exports
